  ...
  return (
    <div className='new-comment'>
      <form onSubmit={submitClicked} >
        <input type="text"  placeholder='Write your thoughts about it...' name='comments' className='comments' value={comment} onChange={(e) => setComment(e.target.value)} style={{borderRadius: '1rem', border: '.25rem solid lightblue', padding: '0.75rem', width: '100rem', height: '0.75rem', marginTop: '1rem', marginRight: '1rem'}}/>
